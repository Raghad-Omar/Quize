...
async function fetchQuestions() {
  ...
  try {
    ...
    console.log("Fetched Questions:", Questions); // Check that Questions is populated
...
function startQuiz() {
  ...
  console.log("Questions Array:", Questions); // Log entire array
  console.log("First Question:", Questions[0]); // Check the first item
  console.log("Questions Length:", Questions.length); // Log the length of the array
...
console.log("*&*&*&",currentQueston.answers);
...
correct_answer=key;
 ...
 console.log("kkk",correct_answer);
